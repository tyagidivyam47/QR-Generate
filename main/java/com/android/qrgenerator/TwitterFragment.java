...
public class TwitterFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        input.setHint("https://www.twitter.com/");

        TextView category = rootView.findViewById(R.id.category);
        category.setText("TWITTER");
        category.setBackgroundColor(getResources().getColor(R.color.twitter_color));
        ...
        generateQRBtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if(data.isEmpty() || ! data.contains("twitter")){
                    Toast.makeText(getContext(). getApplicationContext(), "Please enter valid Twitter URL", Toast.LENGTH_SHORT).show();
                }
                else{
